...
const Home: React.FC = () => {
    ...
    <section className="mb-12 text-center">
        <div className='bg-gray-100 p-8 rounded-3xl'>
          <h2 className="text-4xl font-bold">우리의 청소 서비스</h2>
          <p className="text-lg text-gray-600 mt-4">특수청소, 일반청소, 입주청소까지 모두 가능합니다.</p>
        </div>
      ...
      <section className="mb-12 text-center">
      <div className='bg-gray-100 p-8 rounded-3xl'>
        <h2 className="text-4xl font-bold">왜 깔끔한 방인가요?</h2>
      ...
      <div className='bg-gray-100 p-8 rounded-3xl'>
        <h2 className="text-4xl font-bold">고객 후기</h2>
        <p className="text-lg text-gray-600 mt-4 text-center">우리의 서비스를 이용한 고객들의 실제 후기</p>
      </div>
        ...
        <p className="text-lg text-gray-600">지금 바로 청소 서비스를 예약하고 깨끗한 생활을 시작하세요.</p>
        </div>
        <button onClick={() => navigate('/commissionwrite')} className="bg-[#0bb8f9] text-white py-2 px-4 rounded-md m-2 mt-6">지금 예약하기</button>
        </section>
